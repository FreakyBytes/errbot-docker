...
BACKEND = os.environ.get('ERR_BACKEND', 'XMPP')  # defaults to XMPP
...
BOT_DATA_DIR = os.environ.get('ERR_DATA_DIR', '/err/data')
...
BOT_LOG_LEVEL = {
        ...
        'fatal': logging.FATAL,
        }.get(os.environ.get('ERR_LOG_LEVEL', 'info').lower())
...
BOT_IDENTITY = {
    # XMPP (Jabber) mode
    'username': os.environ.get('ERR_USERNAME', ''),  # The JID of the user you have created for the bot
    'password': os.environ.get('ERR_PASSWORD', ''),  # The corresponding password for this user
    ...
    'token'    : os.environ.get('ERR_TOKEN', ''),
    ...
    'endpoint' : os.environ.get('ERR_ENDPOINT', 'https://api.hipchat.com'),
...
BOT_ADMINS = os.environ.get('ERR_ADMINS', '').split(',')
...
CHATROOM_PRESENCE = os.environ.get('ERR_CHATROOMS', '').split(',')
